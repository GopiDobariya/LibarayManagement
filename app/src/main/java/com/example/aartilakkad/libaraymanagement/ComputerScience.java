...
public class ComputerScience extends AppCompatActivity {
        ...
        services.getBookDetail("Computer Science", new Callback<Response>() {
            ...
            public void success(Response response, Response response2) {
                ...
                try {
                    ...
                    adapterHistoryBook = new AdapterHistoryBook(list,getApplicationContext());
                    rcComputer.setAdapter(adapterHistoryBook);
                }
                catch (Exception e)
                {
                    e.printStackTrace();
    ...
    public class AdapterHistoryBook extends RecyclerView.Adapter<AdapterHistoryBook.ViewHolder> {
        ...
        @Override
        public AdapterHistoryBook.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.details, parent, false);
          AdapterHistoryBook.ViewHolder vh = new AdapterHistoryBook.ViewHolder(v);
            return vh;
        }

        @Override
        public void onBindViewHolder(AdapterHistoryBook.ViewHolder holder, int position) {
