...
public class Artical extends AppCompatActivity {
    ...
    private Artical.AdapterHistoryBook adapterHistoryBook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        services.getBookDetail("Artical", new Callback<Response>() {
            @Override
            public void success(Response response, Response response2) {
                ...
                try {
                    ...
                    adapterHistoryBook = new Artical.AdapterHistoryBook(list,getApplicationContext());
    ...
    public class AdapterHistoryBook extends RecyclerView.Adapter<Artical.AdapterHistoryBook.ViewHolder> {
        ...
        @Override
        public Artical.AdapterHistoryBook.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.details, parent, false);
            Artical.AdapterHistoryBook.ViewHolder vh = new Artical.AdapterHistoryBook.ViewHolder(v);
            return vh;
        }

        @Override
        public void onBindViewHolder(Artical.AdapterHistoryBook.ViewHolder holder, int position) {
