...
public class Gate extends AppCompatActivity {
    ...
    private Gate.AdapterHistoryBook adapterHistoryBook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        services.getBookDetail("Get", new Callback<Response>() {
            @Override
            public void success(Response response, Response response2) {
                ...
                try {
                    ...
                    adapterHistoryBook = new Gate.AdapterHistoryBook(list,getApplicationContext());
    ...
    public class AdapterHistoryBook extends RecyclerView.Adapter<AdapterHistoryBook.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            Gate.AdapterHistoryBook.ViewHolder vh = new Gate.AdapterHistoryBook.ViewHolder(v);
            return vh;
        }
