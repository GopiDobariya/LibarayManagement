...
public class Thesis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        services.getBookDetail("Thesis", new Callback<Response>() {
            @Override
            public void success(Response response, Response response2) {
                ...
                try {
                    ...
                    adapterHistoryBook = new Thesis.AdapterHistoryBook(list,getApplicationContext());
    ...
    public class AdapterHistoryBook extends RecyclerView.Adapter<AdapterHistoryBook.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            Thesis.AdapterHistoryBook.ViewHolder vh = new Thesis.AdapterHistoryBook.ViewHolder(v);
            return vh;
        }
